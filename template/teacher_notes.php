...
<html>
    ...
    <center style="height:50px; background:#71cba4; color:#fff;">
      ...
      ?>
              <div class="col-ls-3 col-md-3 col-sm-3 col-xs-3" style="margin-top:12px;">
                ...
                <button type="button" class="btn btn-success classmate_button" name="button" onclick="view_notes('<?php echo $student->id;?>')">
                  查看读书笔记
                </button>
              </div>
      <?php
  ...
  <script type="text/javascript">
    ...
    {
      id = parseInt(id);
      location.href = "view_notes.php?id="+id+"&type=teacher";
    }
  </script>
</html>
