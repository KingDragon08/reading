...
<html>
  ...
  <body>
    ...
    ?>
        ...
        <ul class="list-group">
            <a href="../template/student_right.php" target="main" class="list-group-item <?php if($unread==-1){echo 'active';}?>">基本资料</a>
            <a href="../template/student_school.php" target="main" class="list-group-item">学校信息</a>
