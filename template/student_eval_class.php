    ...
    <center style="height:50px; background:#71cba4; color:#fff;">
      <h4 style="line-height:50px;">
        ...
        <div class="float_right" style="margin-right:1em;">
          ...
          <button class="btn btn-success active" onclick="">全班</button>
        </div>
      </h4>
    </center>
    <br><br>
      ...
      series : [
          {
              ...
              data:[{value: <?php if($class_students_count){echo round(($class_students_count-$user->get_user_class_rank())/$class_students_count,2)*100;}else{echo 0;}?>,
                              name: '<?php
                                        if($class_students_count)
                                        {
                                          echo '优于全班';
