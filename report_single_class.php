        ...
        <div class="forget_cover">
          <?php
            ...
            <div class="float_right" style="margin-right:5.8em;">
              <button class="btn btn-success" onclick="location.href='report_single_school.php?id=<?php echo $_GET['id'];?>'">全校能力值范围</button>
          ...
          <div class="col-lg-12" style="margin-top:30px; margin-bottom:20px;" id="">
            <div style="width:847px; margin:0 auto;">
              <img src="img/luobo.png" alt="" style="margin-left:<?php
                  ...
                  {
                      echo 829*round(($class_students_count-$user->get_user_class_rank2($id)-1)/($class_students_count-1),2)-4;
                      echo "px;";
                  }
                  else
                  {
