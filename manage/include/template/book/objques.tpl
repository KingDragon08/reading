...
<div class="btn-toolbar" style="margin-bottom:2px;">
    <a href="/reading/manage/user/read_excel.php?type=subques" class="btn btn-primary">批量添加主观题</a>
...
<form class="form_search"  action="" method="GET" style="margin-bottom:0px">
    ...
    <div class="block">
        <a href="#page-stats" class="block-heading" data-toggle="collapse">主观测试题列表</a>
        <div id="page-stats" class="block-body collapse in">
              ...
              <tbody>
                <{foreach name=ques from=$question_infos item=question_info}>
					...
					<td>
					<a href="objques_modify.php?ques_id=<{$question_info.id}>" title= "修改" ><i class="icon-pencil"></i></a>
					&nbsp;
					<a data-toggle="modal" href="#myModal" title= "删除" ><i class="icon-remove" href="objques.php?page_no=<{$page_no}>&method=del&ques_id=<{$question_info.id}>" ></i></a>
					</td>
					</tr>
				<{/foreach}>
              </tbody>
