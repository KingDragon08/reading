...
<html>
  <head>
    ...
    <title>乐智悦读-班级报告</title>
  </head>
  <body>
    <!-- top nav start-->
      <?php
        include_once("top0.php");
    ...
    <!-- forget panel start -->
      <center style="height:50px; background:#71cba4; color:#fff;">
        <h4 style="line-height:50px;">班级报告</h4>
      </center>
      <br>
      <div class="container">
        <?php
          if($role=="3" && $user->check_president_teacher($id))
          {
        ?>
        <!-- 教师开始 -->
        ...
        <div class="container mt20 mb20">
          查看个人报表:&nbsp;&nbsp;&nbsp;&nbsp;
          <?php
            $classes = $user->get_classes_president($id);
            if(count($classes))
            {
          ...
          <?php
            ...
            if($class_id>0)
            {
              ...
              if(!$user->check_class_president($class_id))
              {
          ...
          ?>
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu">
                      ...
                      {
                      ?>
                        <li><a href="?id=<?php echo intval($_GET['id']);?>&class=<?php echo $class->id;?>"><?php echo $class->classname;?></a></li>
                      <?php
